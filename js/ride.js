...
function getWeather(loc, unicorn) {
    let url = `https://api.openweathermap.org/data/3.0/onecall?lat=${loc.latitude}&lon=${loc.longitude}&exclude=minutely,hourly&appid=aa51d74a8d27d496543a237397eb2544`;
    fetch(url)
